    ...
    <div class="num">
      <ul class="count">
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> 较昨日<em style="color: rgb(247, 76, 49)"> {{ numZore(caseNumData.currentConfirmedIncr) }} </em> </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> 较昨日<em style="color: rgb(247, 130, 7)"> {{ numZore(caseNumData.currentConfirmedIncr) }} </em> </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> 较昨日<em style="color: rgb(162, 90, 78)"> {{ numZore(caseNumData.suspectedIncr) }} </em> </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> 较昨日<em style="color: rgb(174, 33, 44)"> {{ numZore(caseNumData.curedIncr) }} </em> </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> 较昨日<em style="color: rgb(93, 112, 146)"> {{ numZore(caseNumData.deadIncr) }} </em> </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> 较昨日<em style="color: rgb(40, 183, 163)"> {{ numZore(caseNumData.seriousIncr) }} </em> </b>
            </div>
...
export default {
  ...
  methods: {
    // 时间戳转成正常事件
    formatData (caseNumData) {
      var date = new Date(caseNumData)
